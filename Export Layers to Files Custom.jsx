...
var strNumberSequenceOptions = localize("$$$/JavaScripts/ExportLayersToFiles/IncludeNumberSequences=Include Number Sequences");
...
function settingDialog(exportInfo) {
    ...
    dlgMain.pnlFileType.pnlOptions.grpPNG24Options.png24IncludeNumberSequence = dlgMain.pnlFileType.pnlOptions.grpPNG24Options.add("checkbox", undefined, strNumberSequenceOptions.toString());
    ...
    dlgMain.pnlFileType.pnlOptions.grpPNG24Options.png24IncludeNumberSequence.value = exportInfo.png24IncludeNumberSequence;
    ...
    exportInfo.png24IncludeNumberSequence = dlgMain.pnlFileType.pnlOptions.grpPNG24Options.png24IncludeNumberSequence.value;
...
function initExportInfo(exportInfo) {
    ...
    exportInfo.png24IncludeNumberSequence = true;
...
function exportChildren(dupObj, orgObj, exportInfo, dupDocRef, fileNamePrefix) {
    ...
    for (var i = 0; i < dupObj.artLayers.length; i++) {
        ...
        // PNG File Option Custom (Number Sequences)
        if (!(png24Index == exportInfo.fileType && exportInfo.png24IncludeNumberSequence == false))
        {
...
function logToHeadLights(eventRecord) {
    ...
    desc.putString(stringIDToTypeID("subcategory"), "Scripts");
